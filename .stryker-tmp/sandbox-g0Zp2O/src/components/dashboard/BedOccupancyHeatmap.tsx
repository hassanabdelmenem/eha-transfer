                  ...
                  if (!cap || cap.total === 0) {
                    return (
                      <td key={bed} className="p-2 text-center">
                        <div className="w-full h-full min-h-[32px] rounded flex items-center justify-center bg-slate-50 dark:bg-slate-900/50 text-slate-300 dark:text-slate-600 text-[10px]">
                          -
                        </div>
                      </td>
                    );
