// @ts-nocheck
export type Role = 'owner' | 'system_admin' | 'medical_director' | 'hospital_manager' | 'deputy_manager' | 'head_of_department' | 'clinician' | 'nursing_supervisor' | 'nurse' | 'er_room';
...
export type ReferralStatus = 'pending' | 'dept_approved' | 'manager_approved' | 'accepted' | 'rejected' | 'in_transit' | 'arrived' | 'admitted' | 'discharged';
