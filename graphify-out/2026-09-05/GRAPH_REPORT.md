...
## Corpus Check
- 668 files · ~416,779 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2059 nodes · 4402 edges · 212 communities (143 shown, 69 thin omitted)
- Extraction: 95% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 184 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `95fa13a0`
...
## Communities (212 total, 69 thin omitted)

### Community 0 - "types/index.ts"
Cohesion: 0.05
Nodes (75): Auditor M1 Forensic Audit Report (App Shell), Challenger M2 Progress Tracker, Challenger M2 Adversarial Challenge Report (RBAC & Persona Simulations), Challenger M3 Briefing (Edge Case & Exception Pathways), Challenger M3 Dispatch Instructions, Challenger M3 Handoff Report (Edge Case Verification), Challenger M3 Progress Log, Challenger M3 Adversarial Challenge Report (Edge Cases) (+67 more)
...
Cohesion: 0.13
Nodes (36): Milestone 2 Quality & Adversarial Review Report (Persona Simulations), Reviewer M3 Re-verification Briefing, Reviewer M3 Re-verification Dispatch, Reviewer M3 Re-verification Handoff Report, Reviewer M3 Re-verification Progress Log, DirectAdmissionModal(), AdminCockpit(), ClinicianCockpit() (+28 more)

### Community 3 - "Milestone5.empirical-adversarial.test.tsx"
Cohesion: 0.06
Nodes (52): Challenger M5-1 Briefing, Challenger M5-1 Handoff Report (Bed Management), Challenger M5-1 Progress Log, Challenger M5-2 Briefing, Challenger M5-2 Handoff Report (E2E/DOM Integration), Challenger M5-2 Progress Log, Bed Capacity Stepper Debounced Writes, Milestone 5: Integrated Bed Management & Capacity Hub (+44 more)
...
Cohesion: 0.09
Nodes (32): Challenger M3_2 Briefing (E2E Verification), Challenger M3_2 Dispatch Instructions, Challenger M3-2 Progress Log, Challenger M4-1 Handoff Report, Challenger M4-1 Progress Log, Challenger M4-2 Briefing, Challenger M4 Briefing, Challenger M4 Handoff Report (+24 more)
...
### Community 10 - "Referral"
Cohesion: 0.16
Nodes (7): ArrivedTransfersQueueProps, NotificationMenu(), NotificationMenuProps, ClinicalSummaryCardProps, DeptApprovalStatus, Notification, Referral
...
### Community 18 - "Reviewer M3-1 Handoff Report"
Cohesion: 0.22
Nodes (10): Reviewer M3-1 Handoff Report, Reviewer M3-1 Progress Log, Reviewer M3-2 Briefing, Reviewer M3-2 Dispatch, Reviewer M3-2 Handoff Report, Reviewer M3-2 Progress Log, DOM Invariant: Overview Heading Selector, Milestone 3: Clinical Cockpits & Role Dashboards (+2 more)

### Community 19 - "Facility"
Cohesion: 0.12
Nodes (16): DirectAdmissionFormProps, DirectAdmissionModalProps, mockAddDirectAdmission, mockFacility, BedOccupancyHeatmapProps, AppSidebarProps, mockFacility, mockReferrals (+8 more)
...
Cohesion: 0.15
Nodes (19): NotificationsPage, ReferralCockpitCard(), ReferralCockpitCardProps, ReferralList(), ReferralListProps, Skeleton(), SkeletonDetailBlock(), SkeletonGroup() (+11 more)
...
### Community 31 - "Challenger M2 Handoff (Milestone 2 APPROVE Verdict)"
Cohesion: 0.39
...
### Community 38 - "mock-data.ts"
Cohesion: 0.60
Nodes (3): FACILITIES, MOCK_USERS, facilityIds
...
### Community 49 - "ManagerCockpit.tsx"
Cohesion: 0.14
Nodes (27): Challenger M3_1 Briefing (Clinical Cockpits & Dashboards), Challenger M3_1 Dispatch Instructions, Reviewer M3_1 Briefing (Clinical Cockpits & Role Dashboards), Milestone 3: Clinical Cockpits & Role Dashboards, Milestone 3 Cockpits Verdict: REQUEST_CHANGES (React Hook Rule Violations), Reviewer Agent M3_1 (Clinical Cockpits & Role Dashboards), ESCALATION_DESC, ESCALATION_LABEL (+19 more)
...
Cohesion: 0.07
Nodes (31): Auditor M3 Dispatch, AdminDashboard, AdmitPatientPage, AppRoutes(), ArchivePage, BedManagementPage, Dashboard, DepartmentPage (+23 more)
...
### Community 55 - "db.ts"
Cohesion: 0.08
Nodes (23): deleteOfflineReferral(), getOfflineReferrals(), ReferralDB, clear, del, getAll, openDB, put (+15 more)

### Community 56 - "Milestone 5: Integrated Bed Management & Capacity Hub"
Cohesion: 0.24
Nodes (12): Challenger M5-1 Dispatch, Challenger M5-2 Dispatch, Worker M2 Handoff Report — Unified Referral Intake Wizard, Worker M2 Progress Log, Milestone 2: Unified Referral Intake Wizard, Worker M5 Briefing — Integrated Bed Management & Capacity Hub, Worker M5 Dispatch — Bed Management Hub Implementation, Worker M5 Handoff Report — Integrated Bed Management & Capacity Hub (+4 more)
...
Cohesion: 0.31
Nodes (6): BANNER_TINT_CLASSES, ReferralDetailHeader(), ReferralDetailHeaderProps, StageRail(), STAGE_LABELS, stageIndexForStatus()
...
### Community 75 - "TransferJourneyCard.tsx"
Cohesion: 0.23
Nodes (6): TransferJourneyCard(), TransferJourneyCardProps, ReferralTimeline(), ReferralTimelineProps, TimelineEvent, StatusTimelineProps

### Community 76 - "Milestone 4: Referral Detail, Timeline & Action Console"
Cohesion: 0.43
Nodes (7): Challenger M4-1 Dispatch, Challenger M4-2 Dispatch, Worker M4 Briefing — Referral Detail, Timeline & Action Console, Worker M4 Dispatch — Referral Detail Console Implementation, Worker M4 Handoff Report — Referral Detail, Timeline & Action Console, Worker M4 Progress Log, Milestone 4: Referral Detail, Timeline & Action Console
...
Cohesion: 0.22
Nodes (9): Challenger M4-1 Briefing, AdminDirectActionsCard(), CancellationDialog(), CancellationDialogProps, EscortAssignmentForm(), EscortAssignmentFormProps, PatientConsentCard(), VoiceTextarea() (+1 more)
...
Cohesion: 0.15
Nodes (12): DOM Test Contracts (Playwright Invariants), RejectionModal(), RejectionModalProps, ESCALATION_DETAIL, ESCALATION_HEADLINE, EscalationAlertBanner(), EscalationAlertBannerProps, EscalationKey (+4 more)
...
## Knowledge Gaps
- **652 isolated node(s):** `functions`, `admin`, `scheduler_1`, `sla_1`, `notificationRecipients_1` (+647 more)
