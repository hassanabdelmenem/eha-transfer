...
## Corpus Check
- 672 files · ~417,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2071 nodes · 4427 edges · 219 communities (158 shown, 61 thin omitted)
- Extraction: 95% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 184 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d7d7fd9a`
...
- tier5-whitebox.adversarial.test.ts
...
Cohesion: 0.15
Nodes (22): AppLayout(), AppSidebar(), AppSidebarProps, mockFacility, mockReferrals, mockUser, CANCEL_LOCKED_STATUSES, SENIOR_CANCEL_ROLES (+14 more)
...
### Community 2 - "useAuth"
Cohesion: 0.17
Nodes (22): ReferralsPage, DirectAdmissionModal(), AdminCockpit(), HodCockpit(), ManagerCockpit(), NurseCockpit(), ReferralList(), useAuth() (+14 more)

### Community 3 - "Milestone5.empirical-adversarial.test.tsx"
Cohesion: 0.09
Nodes (29): Challenger M5-1 Briefing, Challenger M5-1 Handoff Report (Bed Management), Challenger M5-1 Progress Log, Bed Capacity Stepper Debounced Writes, BedCapacityCard(), BedCapacityCardProps, BED_TYPES, BedCapacityGrid() (+21 more)
...
Cohesion: 0.05
Nodes (47): Challenger M3_2 Briefing (E2E Verification), Challenger M3_2 Dispatch Instructions, Challenger M3-2 Progress Log, Challenger M4 Briefing, Challenger M4 Handoff Report, Challenger M4 Progress Log, Challenger M4 Adversarial Challenge Report, buffer (+39 more)
...
Cohesion: 0.27
Nodes (3): NotificationMenu(), NotificationMenuProps, Notification

### Community 11 - "Referral"
Cohesion: 0.26
Nodes (5): ArrivedTransfersQueueProps, AdminDirectActionsCardProps, Referral, User, SimulatedHealthcareNetwork
...
### Community 18 - "ERCockpit"
Cohesion: 0.16
Nodes (16): Reviewer M3-1 Handoff Report, Reviewer M3-1 Progress Log, Reviewer M3-2 Briefing, Reviewer M3-2 Dispatch, Reviewer M3-2 Handoff Report, Reviewer M3-2 Progress Log, Reviewer M3 Re-verification Briefing, Reviewer M3 Re-verification Dispatch (+8 more)

### Community 19 - "Facility"
Cohesion: 0.21
Nodes (15): DirectAdmissionFormProps, DirectAdmissionModalProps, mockAddDirectAdmission, mockFacility, BedOccupancyHeatmapProps, StepDestinationPriorityProps, AiRankedFacility, BED_TYPES (+7 more)

### Community 20 - "DashboardCockpits.test.tsx"
Cohesion: 0.08
Nodes (28): mockAddDeptComment, mockAssignShift, mockDirectAdmissions, mockFacilities, mockFacilitiesById, mockOverrideReferralDestination, mockQuickTransfer, mockReferrals (+20 more)
...
Cohesion: 0.15
Nodes (17): Challenger M3_1 Briefing (Clinical Cockpits & Dashboards), Challenger M3_1 Dispatch Instructions, Reviewer M3_1 Briefing (Clinical Cockpits & Role Dashboards), Milestone 3: Clinical Cockpits & Role Dashboards, Milestone 3 Cockpits Verdict: REQUEST_CHANGES (React Hook Rule Violations), Reviewer Agent M3_1 (Clinical Cockpits & Role Dashboards), ESCALATION_LABELS, EscalationAlertBanner() (+9 more)
...
Cohesion: 0.13
Nodes (14): Milestone 2 Quality & Adversarial Review Report (Persona Simulations), System Admin Destination Override, Accompanying Doctor Escort Dispatch Gate, capturedUpdates, Consumer(), DataContextType, DataProvider(), OFFLINE_SYNC_STALL_TIMEOUT_MS (+6 more)
...
### Community 38 - "BedManagementPage.tsx"
Cohesion: 0.11
Nodes (21): Challenger M5-2 Briefing, Challenger M5-2 Handoff Report (E2E/DOM Integration), Challenger M5-2 Progress Log, Milestone 5: Integrated Bed Management & Capacity Hub, ActiveInpatientCensus(), mockAdmissions, ArrivedTransfersQueue(), mockArrivedReferrals (+13 more)
...
Cohesion: 0.22
Nodes (14): ESCALATION_DESC, ESCALATION_LABEL, ESCALATION_PRIMARY, BED_TYPES, BedOccupancyHeatmap(), ClinicalAttachmentsCardProps, ClinicalHistoryCardProps, ClinicalMedicationsCardProps (+6 more)
...
Cohesion: 0.12
Nodes (14): Reviewer M4-1 Briefing, Reviewer M4-1 Dispatch, Reviewer M4-1 Handoff Report, Reviewer M4-1 Progress Log, Reviewer M4-2 Briefing, Reviewer M4-2 Dispatch, Reviewer M4-2 Handoff Report, Milestone 4: Referral Detail, Timeline & Action Console (+6 more)

### Community 53 - "App.tsx"
Cohesion: 0.09
Nodes (23): AdminDashboard, AdmitPatientPage, AppRoutes(), ArchivePage, BedManagementPage, FacilitySettingsPage, Login, NetworkDirectoryPage (+15 more)
...
### Community 62 - "Data Layer & Business Logic Survey Analysis"
Cohesion: 0.14
...
### Community 64 - "tier5-whitebox.adversarial.test.ts"
Cohesion: 0.24
Nodes (16): Challenger M5-1 Tier 5 White-Box Adversarial Hardening Report, Candidate List Non-Widening Security Invariant, SLA Breach Timing Detection, 30-Minute Fast-Track SLA Breach Threshold, UrgencyTimer(), Clock, hasBreachedSla(), isSlaTracked() (+8 more)
...
### Community 66 - "Frontend UX & Component Architecture Survey"
Cohesion: 0.12
...
### Community 75 - "formatDateTime"
Cohesion: 0.15
Nodes (11): DepartmentReviewCard(), ESCALATION_DETAIL, ESCALATION_HEADLINE, EscalationAlertBanner(), EscalationAlertBannerProps, EscalationKey, ReferralTimeline(), ReferralTimelineProps (+3 more)
...
Cohesion: 0.18
Nodes (12): AdminDirectActionsCard(), CancellationDialog(), CancellationDialogProps, EscortAssignmentForm(), EscortAssignmentFormProps, PatientConsentCard(), PatientConsentCardProps, ReferralActionConsoleProps (+4 more)
...
Cohesion: 0.13
Nodes (14): Handoff Report — Reviewer 2: Unified Referral Intake Wizard, StepDestinationPriority(), WIZARD_STEPS, STEP_ICONS, WizardStepper(), WizardStepperProps, mockAddReferral, DEFAULT_VITALS (+6 more)

### Community 90 - "StepDiagnosticsReview.tsx"
Cohesion: 0.16
Nodes (14): Challenger M2_1 Briefing (Referral Intake Wizard), Challenger M2_1 Dispatch Instructions, Challenger M2_1 Handoff Report (Wizard Stress Test), Challenger M2_1 Progress Log, Reviewer 2 (Milestone 1) Progress Log, Milestone 1 Review Report — Core Exception & Alignment Hardening, Review & Adversarial Verification Report — Unified Referral Intake Wizard (Reviewer 1), ECGViewerOverlay() (+6 more)

### Community 91 - "edge-cases-exceptions.test.ts"
Cohesion: 0.22
Nodes (11): Milestone 3 (R3) Review & Adversarial Challenge Report, db, runSweep(), availableBeds(), CandidateQuery, CapacityCandidate, capacityEscalationReason, describeCapacityEscalation() (+3 more)
...
Cohesion: 0.16
Nodes (10): ClinicalAttachmentsCard(), ClinicalHistoryCard(), ClinicalMedicationsCard(), FooterAction, MobileActionFooter(), MobileActionFooterProps, TransferContextCard(), TransferJourneyCard() (+2 more)
...
### Community 134 - "StepClinicalPresentation.tsx"
Cohesion: 0.17
Nodes (16): Egyptian 14-Digit National ID Decoder, Auditor M2 Forensic Audit Report (Referral Wizard), DraftRestoreBanner(), DraftRestoreBannerProps, StepClinicalPresentation(), StepClinicalPresentationProps, StepPatientDemographics(), StepPatientDemographicsProps (+8 more)

### Community 138 - "rbac-boundaries.test.ts"
Cohesion: 0.21
Nodes (10): Challenger M2 Progress Tracker, Challenger M2 Adversarial Challenge Report (RBAC & Persona Simulations), Milestone 2 Reviewer Handoff Report (Persona Simulations), Bed Capacity Arithmetic Integrity, Multi-Facility Tenant Isolation, RBAC Permission Boundary Enforcement, Tier 3: Unit, Component & Simulation Suites, createTestFacilities() (+2 more)
...
### Community 157 - "cn"
Cohesion: 0.27
Nodes (6): DepartmentReviewCardProps, Badge, BadgeProps, Input, InputProps, cn()

### Community 209 - "Challenger M4-1 Briefing"
Cohesion: 0.20
Nodes (11): Challenger M4-1 Briefing, Challenger M4-1 Handoff Report, Challenger M4-1 Progress Log, Challenger M4-2 Briefing, Milestone 4: Referral Detail, Timeline & Action Console, ActionConsole.tsx, ECGViewer.tsx, MedicalRecordViewer.tsx (+3 more)

### Community 210 - "Dashboard.tsx"
Cohesion: 0.31
Nodes (7): Auditor M3 Briefing, Auditor M3 Dispatch, M3: Clinical Cockpits & Role Dashboards, Dashboard, DepartmentPage, ERDashboard, DepartmentPage()
...
### Community 217 - "PrintableSummary.tsx"
Cohesion: 0.67
Nodes (3): PrintableSummary, PrintableSummaryProps, vital()

### Community 225 - "DirectAdmission"
Cohesion: 0.22
Nodes (8): ActiveInpatientCensusProps, FacilityAnalyticsChartsProps, DirectAdmission, mockAddDirectAdmission, mockDirectAdmission, mockDischargeDirectAdmission, mockFacility, mockUser
...
## Knowledge Gaps
- **663 isolated node(s):** `AppSidebarProps`, `PatientConsentCardProps`, `ReferralActionConsoleProps`, `ClinicalAttachmentsCardProps`, `ClinicalHistoryCardProps` (+658 more)
...
- **What is the exact relationship between `Auditor M1 Forensic Audit Report (App Shell)` and `Auditor M1 Report (Core Exception & Alignment Hardening)`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **What is the exact relationship between `Challenger M5-1 Tier 5 White-Box Adversarial Hardening Report` and `Challenger M5-1 Handoff Report (Bed Management)`?**
