    ...
    <div className="w-full">
      ...
      <div className="block md:hidden space-y-4">
        {filtered.map(referral => {
          ...
          return (
            <Card key={referral.id} className="p-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
        ...
        <table className="w-full text-left">
          ...
          <tbody className="text-xs">
            {filtered.map((referral) => {
              ...
              return (
                <tr key={referral.id} className="border-b border-slate-100 dark:border-slate-800 hover:bg-blue-50/50 dark:hover:bg-slate-800 transition-colors">
